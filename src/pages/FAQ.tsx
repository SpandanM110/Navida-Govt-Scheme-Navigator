...
const faqs = [
  ...
  },
  {
    ...
    answer: "Our eligibility checker uses AI to analyze your profile information (age, income, occupation, state, etc.) and matches it against the criteria of 500+ government schemes to find the ones you qualify for.",
    answerHi: "हमारा पात्रता जांचकर्ता आपकी प्रोफ़ाइल जानकारी का विश्लेषण करने के लिए AI का उपयोग करता है और इसे 500+ सरकारी योजनाओं के मानदंडों से मिलाता है।",
  },
  {
  ...
  },
  {
    ...
    answerHi: "हम आधिकारिक सरकारी पोर्टलों के सीधे लिंक प्रदान करते हैं जहां आप योजनाओं के लिए आवेदन कर सकते हैं। हम आपको आवश्यक दस्तावेजों और आवेदन प्रक्रिया के बारे में भी मार्गदर्शन करते हैं।",
  },
  {
    ...
    answerHi: "हां, नविदा का उपयोग पूरी तरह से मुफ्त है। हमारा मिशन सभी नागरिकों के लिए सरकारी कल्याण योजनाओं को सुलभ बनाना है।",
  },
  {
    question: "What languages are supported?",
    questionHi: "कौन सी भाषाएं समर्थित हैं?",
    answer: "Currently, Navida supports English and Hindi. We're working on adding more regional languages including Tamil, Telugu, Bengali, Marathi, and others.",
    answerHi: "वर्तमान में, नविदा अंग्रेजी और हिंदी का समर्थन करती है। हम तमिल, तेलुगु, बंगाली, मराठी और अन्य सहित अधिक क्षेत्रीय भाषाओं को जोड़ने पर काम कर रहे हैं।",
  },
  {
    question: "How do I use the voice assistant?",
    questionHi: "मैं वॉयस असिस्टेंट का उपयोग कैसे करूं?",
    answer: "Click on the chat bubble in the bottom right corner, then click the microphone icon to speak your question in English or Hindi. Our AI will understand and respond in your preferred language.",
    answerHi: "नीचे दाएं कोने में चैट बबल पर क्लिक करें, फिर अपना प्रश्न अंग्रेजी या हिंदी में बोलने के लिए माइक्रोफोन आइकन पर क्लिक करें।",
  },
];
